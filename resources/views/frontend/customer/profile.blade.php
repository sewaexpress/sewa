                ...
                <div class="main-content">
                    ...
                    <form class="" action="{{ route('customer.profile.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-box bg-white mt-4">
                            ...
                            <div class="form-box-content p-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="number" id="dashboard-phone" class="form-control mb-3" placeholder="{{__('Your Phone')}}" name="phone" value="{{ Auth::user()->phone }}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-2">
                        ...
                        <div class="text-right mt-4">
                            <button id="submit-user-profile" type="submit" class="btn btn-styled btn-base-1 color-white">{{__('Update Profile')}}</button>
                        </div>
                        ...
                        <div class="form-box bg-white mt-4">
                            ...
                            <div class="form-box-content p-3">
                                <div class="row gutters-10">
                                    ...
                                    @else                           
                                        <div class="col-lg-6 mx-auto" onclick="add_new_address_dashboard()">
