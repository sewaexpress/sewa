                        ...
                        @foreach (\App\Slider::where('published', 1)->get() as $key => $slider)
                            <div class="slider_item position-relative">
                                <a href="{{ $slider->link }}" target="_blank">
                                    <img src="{{ asset('uploads/No_Image.jpg') }}" class="d-block w-100 img-fluid"
                                        data-lazy="{{ asset($slider->photo) }}" alt="{{ env('APP_NAME') }}" />
                                </a>
                            </div>
                        @endforeach
                    </div>
                ...
                <div class="product-lists">
                    <div class="row">
                                                            ...
                                                            @if (isset($filepath))
                                                                @if (file_exists(public_path($filepath)))
                                                                    <img src="{{ asset('uploads/No_Image.jpg') }}"
                                                                        alt="{{ $product->name }}"
                                                                        data-lazy="{{ asset($product->featured_img) }}"
                        ...
                        <div class="col-lg-3 col-sm-12">
                            ...
                            @endphp
                            <img src="{{ asset('uploads/No_Image.jpg') }}" data-lazy="{{ asset($banner) }}"
                ...
                @foreach (\App\Banner::where('position', 3)->where('published', 1)->take(1)->get() as $key => $banner)
                    <div class="col-md-12 mb-3">
                        <a href="{{ $banner->url }}">
                            {{-- two_banner_img --}}
                            <div class="">
                                <img src="{{ asset('uploads/No_Image.jpg') }}" data-lazy="{{ asset($banner->photo) }}" class="img-fluid banner-img"
                                        ...
                                        <div class="item">
                                            @if (!empty($brand->logo))
                                                @if (file_exists($brand->logo))
                                                    <img src="{{ asset('uploads/No_Image.jpg') }}" data-src="{{ asset($brand->logo) }}" alt="{{ $brand->name }}"
                ...
                @foreach (\App\Banner::where('position', 1)->where('published', 1)->take(2)->get() as $key => $banner)
                    <div class="col-md-6 mb-3">
                        <a href="{{ $banner->url }}">
                            {{-- two_banner_img --}}
                            <div class="">
                                <img src="{{ asset('uploads/No_Image.jpg') }}" data-lazy="{{ asset($banner->photo) }}" class="img-fluid banner-img lazyload"
                                    alt="{{ env('APP_NAME') }} promo">
                            </div>
                        </a>
                    </div>
        ...
        // $(document).ready(function() {
            ...
            $.post('{{ route('home.section.home_categories') }}', {
                ...
                function(data) {
                    ...
                    $(".featured-section-categories").slick({
                        infinite: true,
                        autoplay: true,
                        slidesToShow: 5,
                        slidesToScroll: 1,
