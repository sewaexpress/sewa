                                ...
                                <div class="col-md-6 col-12">
                                    <div class="float-md-right">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="active"><a href="{{ route('customer.app.refer') }}">{{__('Referrals')}}</a></li>
                                        </ul>
                                        <br>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="dashboard-widget text-center green-widget text-white mt-4 c-pointer">
                                    ...
                                    <span class="d-block title heading-3 strong-400">{{($reward_amount)?$reward_amount->amount:0}}</span>
                                    <span class="d-block sub-title">{{ __('Reward Balance') }}</span>
