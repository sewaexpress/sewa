@foreach (\App\HomeCategory::where('status', 1)->get() as $key => $homeCategory)
   @if ($homeCategory->category != null)
      @if(\App\Product::where('published', 1)->where('category_id', $homeCategory->category_id)->where('current_stock','>',0)->limit('1')->count()>0) 
                            ...
                            <div class="col-md-12">
                                <div class="product-lists">
                                    <div class="right-side-wrapper">
                                        <div class="featured-section-categories">
                                            @foreach (filter_products(\App\Product::where('published', 1)->where('category_id', $homeCategory->category_id))->latest()->limit(10)->get() as $key => $product)
                                            {{-- @php
                                                    dd($product);
                                                @endphp --}}
                                            <div class="grid-item">
