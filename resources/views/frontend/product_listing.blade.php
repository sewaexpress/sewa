...
@section('content')
    ...
    <section id="breadcrumb-wrapper" class="position-relative bg-light">
        ...
        <div class="container">
            <ol class="breadcrumb mt-3 py-3">
                <li class=""><a class="text-dark font-weight-bold" href="{{ route('home') }}">{{ __('Home') }}</a>
                </li>
                <li class=""><a class="text-dark font-weight-bold"
                        href="{{ route('products') }}">{{ __('All Categories') }}</a></li>
                @if (isset($category_id))
                    <li class="active "><a class="text-dark font-weight-bold"
                                                ...
                                                <div class="filter-content1">
                                                    <div class="card-body px-3 py-2">
                                                        <ul class="mb-0">
                                                                ...
                                                                @foreach (\App\Category::all() as $category)
                                                                    <li>
                                                                        <div class="item"><a
                                                                                ...
                                                                                class="category-item py-1">{{ __($category->name) }}</a>
                                                                        </div>
                                                                    </li>
                                                                @endforeach
                                                            @endif
                                                            @if (isset($category_id))
                                                                <li>
                                                                    <div class="item"><a href="{{ route('products') }}"
                                                                            class="active">{{ __('All Categories') }}</a>
                                                                    </div>
                                                                </li>
                                                                <li>
                                                                    <div class="item"><a
                                                                            href="{{ route('products.category', \App\Category::find($category_id)->slug) }}"
                                                                            class="active">{{ __(\App\Category::find($category_id)->name) }}</a>
                                                                    </div>
                                                                </li>
                                                            ...
                                                            @if (isset($subcategory_id))
                                                                ...
                                                                <li>
                                                                    <div class="item"><a
                                                                            href="{{ route('products.category', \App\SubCategory::find($subcategory_id)->category->slug) }}"
                                                                            class="active">{{ __(\App\SubCategory::find($subcategory_id)->category->name) }}</a>
                                                                    </div>
                                                                </li>
                                                                <li>
                                                                    <div class="item"><a
                                                                            href="{{ route('products.subcategory', \App\SubCategory::find($subcategory_id)->slug) }}"
                                                                            class="active">{{ __(\App\SubCategory::find($subcategory_id)->name) }}</a>
                                                                    </div>
                                                                </li>
                                                            ...
                                                            @if (isset($subsubcategory_id))
                                                                ...
                                                                <li>
                                                                    <div class="item"><a
                                                                            href="{{ route('products.category', \App\SubsubCategory::find($subsubcategory_id)->subcategory->category->slug) }}"
                                                                            class="active">{{ __(\App\SubSubCategory::find($subsubcategory_id)->subcategory->category->name) }}</a>
                                                                    </div>
                                                                </li>
                                                                <li>
                                                                    <div class="item"><a
                                                                            href="{{ route('products.subcategory', \App\SubsubCategory::find($subsubcategory_id)->subcategory->slug) }}"
                                                                            class="active">{{ __(\App\SubsubCategory::find($subsubcategory_id)->subcategory->name) }}</a>
                                                                    </div>
                                                                </li>
                                                                <li>
                                                                    <div class="item"><a
                                                                            href="{{ route('products.subsubcategory', \App\SubsubCategory::find($subsubcategory_id)->slug) }}"
                                                                            class="current">{{ __(\App\SubsubCategory::find($subsubcategory_id)->name) }}</a>
                                                                    </div>
                                                                </li>
                                                            @endif
                                                        </ul>
                                                        ...
                                                        @for ($i = 1; $i <= 5; $i++)
                                                            <li>
                                                                <input type="radio" name="rating"
                                                                    value="{{ $i }}" onchange="filter()"
                                                                    title="{{ $i }} star" />

                                                                @for ($j = 1; $j <= $i; $j++)
                                                                    <label class="fa fa-star fa-2x"
                                                                        for="star{{ $i }}"
                                                                        title="{{ $i }} star"
                                                    ...
                                                    <div class="card-group-item">
                                                        <div class="card-head">
                                                            <div
                                                                class="heading d-flex align-items-center text-center flex-wrap">
                                                                <div class="head">
                                                                    <h6 class="text-capitalize m-0">Choose
                                        ...
                                        <div class="col-3">
                                            <div class="sort-by-box px-1">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control sortSelect"
                                                        data-placeholder="{{ __('All Locations') }}" name="location"
                                                        onchange="filter()">
                                                        <option value="">{{ __('All Locations') }}</option>
                                                        @foreach (\App\Location::all() as $location)
                                                            <option value="{{ $location->id }}"
                                                                @isset($location_id) @if ($location_id == $location->id) selected @endif @endisset>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        @if (!intval($product->discount, 0) == 0)
                                                                            <div>
                                                                                ...
                                                                                -{{ intval($product->discount) }}{{ !($product->discount_type == 'amount') ? ' %' : '' }}
    ...
    <!-- Modal -->
    <div class="modal fade" id="leftsidebarfilter" tabindex="-1" role="dialog"
        aria-labelledby="leftsidebarfilterlabel" aria-hidden="true">
                                    ...
                                    <div class="card-body p-3">
                                        <ul class="mb-0">
                                            ...
                                            @if (isset($category_id))
                                                <li>
                                                    <div class="item"><a href="{{ route('products') }}"
                                                            class="active">{{ __('All Categories') }}</a></div>
                                                </li>
                                                <li>
                                                    <div class="item"><a
                                                            href="{{ route('products.category', \App\Category::find($category_id)->slug) }}"
