...
<body>
    @foreach ($orders as $order)
        <div style="margin-left:auto;margin-right:auto;" class="breakpage">
            ...
            <div style="background: #eceff4;padding: 1.5rem;">
                ...
                <table>
                    ...
                    @else
                        <tr>
                            <td style="font-size: 1.2rem;" class="strong">{{ $generalsetting->site_name }}
                            </td>
                            <td class="text-right"></td>
                        </tr>
                        <tr>
            ...
            <div style="padding: 1.5rem;padding-bottom: 0">
                <table>
                    ...
                    <tr>
                        <td class="gry-color small">{{ $shipping_address->address }},
                            {{ $shipping_address->city }}, {{ $shipping_address->country }}</td>
                    </tr>
                    <tr>
                ...
                <table style="width: 40%;margin-left:auto;" class="text-right sm-padding small strong">
                    <tbody>
                        <tr>
                            ...
                            <td class="currency">
                                {{ single_price($order->orderDetails->where('seller_id', $user_id)->sum('price')) }}
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr class="border-bottom">
                            ...
                            <td class="currency">
                                {{ single_price($order->orderDetails->where('seller_id', $user_id)->sum('tax')) }}
                            </td>
                        </tr>
                        <tr>
