...
Route::prefix('v1')->group(function () {
    ...
    Route::post('validate-coupon', 'Api\CustomerController@validateCoupon')->middleware('auth:api');
    Route::post('rate-product', 'Api\CustomerController@rateProduct')->middleware('auth:api');
